...
# debian-iso-builder-include-pacstall-gnome-shell-layout-wincity
...
> [debian-iso-builder-include-pacstall-gnome-shell-layout-wincity](https://samwhelp.github.io/debian-iso-builder-include-pacstall-gnome-shell-layout-wincity)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-wincity/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-wincity/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-wincity/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-include-pacstall-gnome-shell-layout-wincity](https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-wincity)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-wincity.git
```


> change dir to `debian-iso-builder-include-pacstall-gnome-shell-layout-wincity`

``` sh
cd debian-iso-builder-include-pacstall-gnome-shell-layout-wincity
```
...
> The resulting ISO file will be placed on `debian-iso-builder-include-pacstall-gnome-shell-layout-wincity/dist`
